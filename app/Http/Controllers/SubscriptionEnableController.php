    	...
    	if(isset($request->ENABLE_INSTRUCTOR_SUBS_SYSTEM)){
	        ...
	        if($body->item->id == '25613271'){
	            if($body->license == 'Extended License'){
	                ...
	                $message = __("Instructor subscription enabled successfully !");
	            ...
	            $env_keys_save->save();
	            $message = __("Instructor subscription cannot be enabled with this Regular license.");
	            ...
	            $env_keys_save->save();
	            $message = __("Instructor subscription cannot be enabled with this purchase code.");
	            notify()->error($message);
	            return back()->withInput();
	        }
        }else{
