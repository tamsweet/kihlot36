          ...
          <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6 col-6">
                ...
                <input value="{{ old('fname') }}" autofocus required name="fname" type="text" class="form-control" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.FirstName') }}"/>
              </div>
              <div class="col-md-6 col-6">
                <label for="lname">
                  {{ __('adminstaticword.LastName') }}:<sup class="redstar">*</sup>
                </label>
                <input value="{{ old('lname')}}" required name="lname" type="text" class="form-control" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.LastName') }}"/>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-6">
                 <label for="mobile">{{ __('adminstaticword.Email') }}: <sup class="redstar">*</sup></label>
                  <input value="{{ old('email')}}" required type="email" name="email" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Email') }}" class="form-control">
              </div>
              <div class="col-md-6">
                <label for="mobile">{{ __('adminstaticword.Mobile') }}: <sup class="redstar">*</sup></label>
                <input value="{{ old('mobile')}}" required type="text" name="mobile" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Mobile') }}" class="form-control">
              </div>
            </div>
            <br>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input required type="password" name="password" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Password') }}" class="form-control">
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <textarea name="address" rows="2"  class="form-control" placeholder="{{ __('adminstaticword.Enter') }} address"></textarea>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3"> 
                ...
                <input value="{{ old('pin_code')}}" placeholder="{{ __('adminstaticword.Enter') }} pincode" type="text" name="pin_code" class="form-control">
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="exampleInputSlug">{{ __('adminstaticword.Image') }}: </label> <p class="inline info">{{ __('adminstaticword.Recommendedsize') }}: 625x625</p>
                <br>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <textarea id="detail" name="detail" rows="3"  class="form-control" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Detail') }}"></textarea>
              </div>
            </div>
            <br>
            <br>
