    ...
    <div class="container-fluid">
        ...
        <div class="order-table table-responsive">
          <table class="table table-striped">
            <thead>
	            <tr>
	              <th class="invoice-col">{{ __('adminstaticword.Instructor') }}</th>
	              <th class="invoice-col">{{ __('adminstaticword.Currency') }}</th>
	             
	              <th class="invoice-col">{{ __('adminstaticword.Total') }}</th>
	              <th class="invoice-col">{{ __('adminstaticword.PaymentMethod') }}</th>
	            </tr>
	          </thead>
	          <tbody>
	            <tr class="view-order">
