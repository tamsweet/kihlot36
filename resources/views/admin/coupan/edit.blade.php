            ...
            <div class="col-md-8">
                <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputDetails">{{ __('adminstaticword.CouponCodedisplayonfront') }}:</label>
                                 <input class="tgl tgl-skewed" name="show_to_users"  id="frees" type="checkbox" {{ $coupan->show_to_users=="1" ? 'checked' : '' }}>
                    ...
                    <a href="{{ route('coupon.index') }}" title="Cancel and go back"
                        class="btn btn-md btn-default btn-flat"><i class="fa fa-reply"></i>
