                ...
                <div class="box box-primary">
                    ...
                    <form action="{{ route('coupon.store') }}" method="POST">
                        ...
                        <div class="box-body">
                            ...
                            <div id="bundlebox" class="form-group display-none">
                                <label>{{ __('adminstaticword.SelectBundle') }}: <span class="redstar">*</span> </label>
                                <br>
                            ...
                            <div id="catbox" class="form-group display-none">
                                <label>{{ __('adminstaticword.SelectCategories') }}: <span class="required">*</span>
                                </label>
                                <br>
                            ...
                            <div class="form-group">
                                <label for="exampleInputDetails">{{ __('adminstaticword.CouponCodedisplayonfront') }}:</label>
                                 <input {{ old('show_to_users') == "0" ? '' : "checked" }} class="tgl tgl-skewed" name="show_to_users"  id="frees" type="checkbox">
