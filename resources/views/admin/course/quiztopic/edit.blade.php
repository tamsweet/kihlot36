        ...
        <div class="panel-body">
           ...
           <form id="demo-form2" method="POST" action="{{route('quiztopic.update', $topic->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <label for="exampleInputTit1e">{{ __('Quiz Type') }}:</label>
                            <li class="tg-list-item">              
                              <input class="tgl tgl-skewed" id="type112" type="checkbox" name="type" {{ $topic->type == '1' ? 'checked' : '' }} >
                              <label class="tgl-btn" data-tg-off="Disable" data-tg-on="Enable" for="type112"></label>
                            </li>
                            <input type="hidden" name="free" value="0" for="quiz_again" id="123">
                        </div>
                      </div>
