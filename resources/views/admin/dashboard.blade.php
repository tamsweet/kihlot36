...
<section class="content-header">
  <h1>
    ...
    <small>{{ $gsetting->project_title }}</small>
  </h1>
  <ol class="breadcrumb">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>
              	@php
              		$user = App\User::where('status', '1')->count();
              		if($user>0){
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
              	@php
              		$cat = App\Categories::where('status', '1')->count();
              		if($cat>0){
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>
              	@php
              		$course = App\Course::where('status', '1')->count();
              		if($course>0){
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3>
              	@php
              		$page = App\Order::where('status', '1')->count();
              		if($page>0){
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
                @php
              		$review = App\User::where('status', '1')->where('role', 'instructor')->count();
              		if($review>0){
