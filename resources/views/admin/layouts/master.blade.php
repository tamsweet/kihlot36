  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <span class="logo-mini">
        <img title="{{ $gsetting->project_title }}" width="20px" src="{{ url('images/favicon/'.$gsetting->favicon) }}" alt=""/>
      </span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"> <img title="{{ $gsetting->project_title }}" width="100px" src="{{ url('images/logo/'.$gsetting->logo) }}" alt=""/></span>
    </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown notifications-menu">
              ...
              <ul class="dropdown-menu">
                <li class="header">You have {{ Auth()->user()->unreadNotifications->where('type', 'App\Notifications\AdminOrder')->count() }} notifications</li>
                <li>
                ...
                <li class="footer"><a href="{{route('deleteNotification')}}">Clear all</a></li>
              </ul>
            </li>
            @endif
