            ...
            <form id="demo-form2" method="post" action="{{url('faq/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="title" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Title') }}" id="exampleInputTitle" value="">
                </div>
              </div>
              <br>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea id="detail" name="details" class="form-control" rows="5" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Detail') }}" value=""></textarea>
                </div>
              </div>
              <br>
