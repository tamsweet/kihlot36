	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group{{ $errors->has('meta_data_desc') ? ' has-error' : '' }}">
				...
				<textarea placeholder="Enter description" class="form-control" name="meta_data_desc" id="meta_data_desc" cols="30" rows="10">{{ $setting->meta_data_desc }}</textarea>
		...
		<div class="col-md-6">
			<div class="form-group{{ $errors->has('meta_data_keyword') ? ' has-error' : '' }}">
				...
				<textarea placeholder="Use Comma to seprate keyword" class="form-control" name="meta_data_keyword" id="meta_data_keyword" cols="30" rows="10">{{ $setting->meta_data_keyword }}
				</textarea>
