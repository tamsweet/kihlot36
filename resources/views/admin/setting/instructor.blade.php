	          		...
	          		<form action="{{ route('instructor.update') }}" method="POST">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<li class="tg-list-item">              
						            <input class="tgl tgl-skewed" id="paytm" type="checkbox" name="paytm_enable" {{ optional($setting)['paytm_enable'] == '1' ? 'checked' : '' }} >
						...
						<div class="row">
							<div class="col-md-12">
								...
								<li class="tg-list-item">              
						            <input class="tgl tgl-skewed" id="paypal" type="checkbox" name="paypal_enable" {{ optional($setting)['paypal_enable'] == '1' ? 'checked' : '' }} >
						...
						<div class="row">
							<div class="col-md-12">
								...
								<li class="tg-list-item">              
						            <input class="tgl tgl-skewed" id="bank" type="checkbox" name="bank_enable" {{ optional($setting)['bank_enable'] == '1' ? 'checked' : '' }} >
