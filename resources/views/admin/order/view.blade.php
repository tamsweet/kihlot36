                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @else
                          ...
                          (-)&nbsp;{{ $show['coupon_discount'] }}<i class="{{ $show['currency_icon'] }}"></i>
                        @endif
                      </td>
                      @endif
                      ...
                      <td>
                        @if($show->coupon_discount == !NULL)
                          ...
                          @else
                            {{ $show['total_amount'] - $show['coupon_discount'] }}<i class="fa {{ $show['currency_icon'] }}"></i>
                          @endif
                        @else
                          @if($gsetting['currency_swipe'] == 1)
                          ...
                          @else
                            {{ $show['total_amount'] }}<i class="fa {{ $show['currency_icon'] }}"></i>
                          @endif
                        @endif
                      </td>
                    </tr>
