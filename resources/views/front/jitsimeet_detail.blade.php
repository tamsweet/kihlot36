        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="about-home-block text-white">
                    ...
                    <li><a href="#" title="about">Start At: {{ date('d-m-Y | h:i:s A',strtotime($jitsimeet['start_time'])) }}</a></li>
                    ...
                    <div class="about-home-dtl-training">
                        <div class="about-home-dtl-block btm-10">
                            ...
                            <div class="about-home-btn btm-20">
                                <a href="{{url('meetup-conferencing/'.$jitsimeet->meeting_id) }}" target="_blank" class="btn btn-secondary">Join Meeting</a>
                            </div>
                        </div>
                    </div>
                </div>
