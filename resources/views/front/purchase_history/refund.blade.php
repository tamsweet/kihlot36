			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="refund-policy">
						<ul>
							@if($gsetting['currency_swipe'] == 1)
								<li><b>Order price</b>: <i class="{{ $order['currency_icon'] }}"></i> {{ $order->total_amount }}</li>
							@else
								<li><b>Order price</b>: {{ $order->total_amount }}<i class="{{ $order['currency_icon'] }}"></i> </li>
							@endif
							
							<li><b>Refund Policy</b>: {!! $policy->detail !!}</li>
						</ul>
					</div>
					<br>
		            ...
		            {{ method_field('POST') }}
	                    ...
	                    <div class="form-group">
	                        <label for="bio">{{ __('frontstaticword.RefundMode') }}</label>
	                        <select id="refund_mode" class="form-control js-example-basic-single" name="refund_mode" required>
			                    ...
			                    <option value="original">Orginal Source</option>
			                    @endif
	                    ...
	                    @if(isset($user_bank))
	                     ...
	                     <div class="display-none" id="bank_box">
		                    ...
		                    <div class="form-group" style="width: 100%">
		                        <label for="bio">{{ __('frontstaticword.SelectBank') }}</label>
