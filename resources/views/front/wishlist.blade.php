                                ...
                                <ul>
                                    ...
                                    @if($wish->courses->discount_price == !NULL)
                                        @if($gsetting['currency_swipe'] == 1)
                                            <li><a><b><i class="{{ $currency->icon }}"></i>{{ $wish->courses->discount_price }}</b></a></li>&nbsp;
                                            <li><a><b><strike><i class="{{ $currency->icon }}"></i>{{ $wish->courses->price }}</strike></b></a></li>
                                        @else
                                            <li><a><b>{{ $wish->courses->discount_price }}<i class="{{ $currency->icon }}"></i></b></a></li>&nbsp;
                                            <li><a><b><strike>{{ $wish->courses->price }}<i class="{{ $currency->icon }}"></i></strike></b></a></li>
                                        @endif
                                    ...
                                    @else
                                        ...
                                        @else
                                            <li><a><b>{{ $wish->courses->price }}<i class="{{ $currency->icon }}"></i></b></a></li>
                                        @endif
                                    @endif
                                </ul>
                            </div>
