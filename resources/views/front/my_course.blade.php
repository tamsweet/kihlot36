                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="view-block">
                            ...
                            <div class="view-dtl">
                                ...
                                <p class="btm-10"><a herf="#">{{ __('frontstaticword.by') }} @if(isset($meeting->user)) {{ $meeting->user['fname'] }} @endif</a></p>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <div class="view-block">
                                        ...
                                        <div class="view-dtl" style="height: 170px">
                                            ...
                                            <p class="btm-10"><a href="#">by @if(isset($enrol->courses->user)) {{ $enrol->courses->user->fname }} @endif</a></p>
                                            <div class="rating">
                                                <ul>
                                                    <li>
                                                        <!-- star rating -->
                            ...
                            <div class="col-lg-3 col-sm-6">
                                ...
                                <div class="view-block">
                                    ...
                                    <div class="view-dtl" style="height: 170px">
                                        ...
                                        <p class="btm-10"><a href="#">by @if(isset($coursess->user)) {{ $coursess->user->fname }} @endif</a></p>
                                        <div class="rating">
                                            <ul>
                                                <li>
                                                    <!-- star rating -->
