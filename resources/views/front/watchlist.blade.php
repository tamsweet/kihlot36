...
<section id="learning-courses" class="learning-courses-main-block">
    <div class="container">
    	...
    	<h4 class="cart-heading">
            ...
            @endphp
        	  {{ __('frontstaticword.Courses') }} {{ __('frontstaticword.in') }} {{ __('frontstaticword.Watchlist') }}
        	</b>
        </h4>
        <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 col-md-4">
                    <div class="view-block">
                        ...
                        <div class="view-dtl">
                            ...
                            <p class="btm-10"><a href="#">{{ __('frontstaticword.by') }} {{ $wish->courses->user->fname }}</a></p>
                            <div class="rating">
                                <ul>
                                    <li>
                                        <?php 
                        	...
                        	<div class="col-md-6 col-6">
                                <div class="wishlist-btn txt-rgt">
                                    <form  method="post" action="{{route('active.delete', $wish->id)}}" data-parsley-validate class="form-horizontal form-label-left">
            	                      ...
            	                      <button type="submit" class="btn btn-primary " title="{{ __('frontstaticword.Remove') }}"><i class="fa fa-trash"></i></button>
            	                    </form>
                                </div>
                        	</div>
                        </div>
