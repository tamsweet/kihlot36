        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="about-home-block text-white">
                    ...
                    <ul>
                        <li><a href="#" title="about">{{ __('frontstaticword.Created') }}: {{ $zoom->user['fname'] }} </a></li>

                        @if($zoom->type != '3')
                        <li><a href="#" title="about">Start At: {{ date('d-m-Y | h:i:s A',strtotime($zoom['start_time'])) }}</a></li>
                        @endif
                    ...
                    <div class="about-home-dtl-training">
                        <div class="about-home-dtl-block btm-10">
                            ...
                            <div class="about-home-btn btm-20">
                                <a href="{{ $zoom->zoom_url }}" class="iframe btn btn-secondary">Join Meeting</a>
                            </div>
